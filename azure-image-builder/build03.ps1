...
# Builds Windows 10 19H2 image

# Define variables for information that will be used repeatedly
# Destination image resource group name
$imageResourceGroup = 'rg-SharedImageGallery'

# Azure region
$location = 'EastUS'

# Name of the image to be created
$imageTemplateName = 'Win10'
...
$ImgCustomParams = @{
  ...
  RunElevated = $false
  ScriptUri = "https://raw.githubusercontent.com/mikerodrick/PowerShell/master/azure-image-builder/AzureImageBuilder.ps1"
}
...
New-AzVM -ResourceGroupName $imageResourceGroup -Image $ArtifactId -Name win10-19h2 -Credential $Cred
